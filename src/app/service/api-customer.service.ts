...
export class ApiCustomerService {
  ...
  getCusomerBySearch(search: CustomerSearch, page: number, pagesize: number,
   orderbycolumn: string, orderbydirection: string): Observable<object> {
    if (this.list) {
    ...
    if (search) {
      ...
      if (search.fulltext) {
        templist = templist.filter(x => x.name.toLowerCase().includes(search.fulltext.toLowerCase()) ||
                         ...
                         x.province.toLowerCase().includes(search.fulltext.toLowerCase()));
      }

      if (search.name) {
        templist = templist.filter(x => x.name.toLowerCase().trim() === search.name.toLowerCase().trim());
      }
      if (search.surname) {
        templist = templist.filter(x => x.surname.toLowerCase().trim() === search.surname.toLowerCase().trim());
      }
      if (search.address) {
        templist = templist.filter(x => x.address.toLowerCase().trim() === search.address.toLowerCase().trim());
      }
      if (search.cap) {
        templist = templist.filter(x => x.cap.toLowerCase().trim() === search.cap.toLowerCase().trim());
      }
      if (search.city) {
        templist = templist.filter(x => x.city.toLowerCase().trim() === search.city.toLowerCase().trim());
      }
      if (search.province) {
        templist = templist.filter(x => x.province.toLowerCase().trim() === search.province.toLowerCase().trim());
      }
